...
int main(void) {
    ...
    nary_tree_add_child(diretor, "Gerente de TI", 1);
    nary_tree_add_child(diretor, "Gerente de Vendas", 1);
    nary_tree_add_child(diretor->first_child, "Desenvolvedor", 1);
    nary_tree_add_child(diretor->first_child->next_sibling, "Analista de Vendas", 1);
